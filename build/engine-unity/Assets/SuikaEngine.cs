...
public class SuikaEngine : MonoBehaviour
{
	...
	void log_info(IntPtr s)
	{
		string str = Marshal.PtrToStringUTF8(s);
		Debug.Log(str);
	}

	void log_warn(IntPtr s)
	{
		string str = Marshal.PtrToStringUTF8(s);
		Debug.Log(str);
	}

	void log_error(IntPtr s)
	{
		string str = Marshal.PtrToStringUTF8(s);
		Debug.Log(str);
	}
	...
	void make_valid_path(IntPtr dir, IntPtr fname, IntPtr dst, int len)
	{
		string Path = "";
		if (dir != IntPtr.Zero)
	...
	void notify_image_update(IntPtr img)
	{
	...
	void notify_image_free(IntPtr img)
	{
		Image Image = Marshal.PtrToStructure<SuikaEngine.Image>(img);
	...
	void render_image_normal(int dst_left, int dst_top, int dst_width, int dst_height, IntPtr src_img, int src_left, int src_top, int src_width, int src_height, int alpha)
	{
	...
	void render_image_add(int dst_left, int dst_top, int dst_width, int dst_height, IntPtr src_img, int src_left, int src_top, int src_width, int src_height, int alpha)
	{
		Image SrcImage = Marshal.PtrToStructure<SuikaEngine.Image>(src_img);
	...
	void render_image_dim(int dst_left, int dst_top, int dst_width, int dst_height, IntPtr src_img, int src_left, int src_top, int src_width, int src_height, int alpha)
	{
		Image SrcImage = Marshal.PtrToStructure<SuikaEngine.Image>(src_img);
	...
	void render_image_rule(IntPtr src_img, IntPtr rule_img, int threshold)
	{
		Image SrcImage = Marshal.PtrToStructure<SuikaEngine.Image>(src_img);
	...
	void render_image_melt(IntPtr src_img, IntPtr rule_img, int progress)
	{
		Image SrcImage = Marshal.PtrToStructure<SuikaEngine.Image>(src_img);
		Image RuleImage = Marshal.PtrToStructure<SuikaEngine.Image>(rule_img);
	...
	void render_image_3d_normal(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, IntPtr src_img, int src_left, int src_top, int src_width, int src_height, int alpha)
	{
		Image SrcImage = Marshal.PtrToStructure<SuikaEngine.Image>(src_img);
	...
	void render_image_3d_add(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4, IntPtr src_img, int src_left, int src_top, int src_width, int src_height, int alpha)
	{
		Image SrcImage = Marshal.PtrToStructure<SuikaEngine.Image>(src_img);
	...
	void reset_lap_timer(IntPtr origin)
	{
